...
class GameHandler:
    ...
    def test_game_controller(self):
        return GameControllerFactory(
            ...
            PlayerFactory(
                [
                    CharacterFactory("niko",3,100,3,2,5,2,2).json,
                    CharacterFactory("magic_rat",3,100,3,2,5,2,4).json,
                    CharacterFactory("chef",3,100,3,2,5,4,4).json,
                ]
            ).json,
            PlayerFactory(
                [
                    CharacterFactory("grunt1",3,100,3,2,5,20,2).json,
                    CharacterFactory("grunt2",3,100,3,2,5,20,4).json,
                    CharacterFactory("sheriff",3,100,3,2,5,30,4).json,
                ]
            ).json,
            False
        ).json
